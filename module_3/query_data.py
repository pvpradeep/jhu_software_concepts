...
2. What percentage of entries are from interna5onal students (not American or Other) (to two
decimal places)?
...
7. How many entries are from applicants who applied to JHU for a masters degrees in Computer
   Science?
